...
def apply_highlight_test(frame, pred_bboxes, alpha=0.5, expand_ratio=3.0):
    """Görüntüyü takip edilen drone'ların tahmin edilen konumlarına göre karartır/parlatır."""
    h, w, _ = frame.shape
    ...
    # List of lists check for backwards compatibility
